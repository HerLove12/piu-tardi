...
$target_dir = "../images/" . $_SESSION["utente"] ."/". $max+1 . "/";// finire di creare il path per le foto --> trovare modo per ottenere l'ultimo id
...
if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
    $sql = "INSERT INTO annuncio (nome, descrizione, ID_utente, ID_tipologia, foto) 
            VALUES ('$n', '$d', {$_SESSION["utente"]}, $t, '$target_file')";
